...
|------|-----------|---------|
| Spatial | [Interpretable Memory — MWM (sibling repo)](https://github.com/Playful-Sincerity/MWM-Memory-as-World-Model) | The graph as interpretable world model. 4-month Fellows 2026 target. See [memory/](memory/) for how it fits into SSP. |
