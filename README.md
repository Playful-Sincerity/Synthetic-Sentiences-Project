...
|------|-----------|---------|
| Spatial | [Interpretable Memory — MWM (sibling repo)](https://github.com/Playful-Sincerity/MWM-Memory-as-World-Model) | The graph as interpretable world model. See [memory/](memory/) for how it fits into SSP. |
